  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $insertQuery = "INSERT INTO appointments (customer_id, date, time, service) VALUES ('$customer_id', '$date', '$time', '$service')";
      ...
      <form method="POST" action="">
        ...
        <div class="text-center mt-4">
          <button type="submit" class="btn btn-success mr-2"><i class="fas fa-calendar-plus"></i> Add Appointment</button>
