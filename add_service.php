...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($connection->query($query)) {
        ...
        echo "<div class='alert alert-danger'>❌ Error while adding service: " . $connection->error . "</div>";
    }
}
?>
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      if (isset($connection) && isset($connection->error) && $connection->error != "") {
      ...
      <form method="POST" action="">
        ...
        <div class="text-center mt-4">
          <button type="submit" class="btn btn-success"><i class="fas fa-plus-circle"></i> Add Service</button>
