  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $insertQuery = "INSERT INTO customers (first_name, last_name, phone, email) VALUES ('$first_name', '$last_name', '$phone', '$email')";
      ...
      <form method="POST" action="">
        ...
        <div class="text-center mt-4">
          <button type="submit" class="btn btn-success mr-2"><i class="fas fa-plus-circle"></i> Add Customer</button>
